  ...
  return (
    <div className='grid items-center grid-cols-3 row-auto w-[90%] mx-auto my-20 font-poppins justify-items-center'>
        ...
        <div className='flex flex-col items-start'>
            ...
            <p className='text-sm'>We always care about our customer</p>
        </div>
        </div>
        <div className='flex items-center gap-3'>
        ...
        <div className='flex flex-col items-start'>
            ...
            <p className='text-sm '>We offer free frame on every paint</p>
        </div>
        </div>
        <div className='flex items-center gap-3'>
        ...
        <div className='flex flex-col items-start'>
            ...
            <p className='text-sm '>We never compromise with customers</p>
        </div>
        </div>
    </div>
  )
