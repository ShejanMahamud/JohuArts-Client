...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-transparent font-poppins shadow-md px-10 relative z-50">
...
/>
  ...
  {
  user && <div className="dropdown dropdown-end flex items-center gap-2" >
  <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
    <div className="w-12 rounded-full border-2 border-primary" data-tooltip-id="name" data-tooltip-content={user?.displayName}>
  ...
  <li className="font-bold py-2 px-4">Hi! {user?.displayName || "User"}</li>
    ...
    <button onClick={()=>navigate('/register')} className="hover:bg-primary border border-primary duration-700 hover:text-white px-4 py-2 rounded-md font-medium flex items-center gap-1 uppercase text-primary">
      Register</button>
      <button onClick={()=>navigate('/login')} className="bg-primary text-white px-4 py-2 hover:border-primary hover:border hover:bg-transparent hover:text-primary rounded-md font-medium flex items-center gap-1 uppercase border border-primary duration-700">
      Login</button>
    </div>
    }
