...
const ReviewCard = ({image,title,description,name,profession}) => {
  ...
  return (
    <div className='w-full px-8 py-5 bg-white shadow-xl rounded-lg *:mb-3 flex flex-col justify-between my-10 font-poppins' data-aos="fade-up">
...
<div className='flex items-center gap-3'>
    ...
    <div className='flex flex-col items-start'>
        <h1 className='text-gray-800 font-bold text-base'>{name}</h1>
